...
struct flags
{
  ...
  bool bandChanged      = true;   //used to indicate long press of VFO tuning rate UP OR DOWN button ++++++++++++++++++++++++++++++
  };
struct flags flag;
// ---------------------------------------------------
...
{
  unsigned int vfo_A_default            = bands[bandA];        // default start frequency - defined in user defines SCD_2021_Vx.xx.INO
  unsigned int vfo_B_default            = bands[bandB];        // default start frequency - defined in user defines SCD_2021_Vx.xx.INO
  ...
  int RIT_A_Display_value             = 0;                  //variable just for display purposes, allows RIT to be displayed as an offset not full freq.
  int RIT_B_Display_value             = 0;                  //variable just for display purposes, allows RIT to be displayed as an offset not full freq.
...
int RIT_A_freq_cursor_pos_x = 175;    // position for top left WAS 125+++++++++++++++++++++++++++++
int RIT_A_hz_pos_x = 215;             //Fix position for printing "Hz" +++++++++++++++++++++++++++++
...
int RIT_B_freq_cursor_pos_x = 175;    // position for top left WAS 125+++++++++++++++++++++++++++++
int RIT_B_hz_pos_x = 230;             //Fix position for printing "Hz" +++++++++++++++++++++++++++++
